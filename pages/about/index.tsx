    ...
    <div className='max-w-6xl px-8 mx-auto'>
      <div className='space-y-4'>
        ...
        <p className='leading-relaxed paragraphSize text-paragraph'>
          ...
          During my first two years of graduation, I spent countless hours with
          my friends, immersing myself in the intricacies of the digital world.
          I learned the fundamentals of programming, delved into the inner
        ...
        <p className='leading-relaxed paragraphSize text-paragraph'>
          ...
          continued to solve problems using this language. However, I eventually
          found that my true passion lay in using Python. I migrated to Python
          and have been solving problems with it ever since. To further improve
          my skills, I entered on a journey to master{' '}
          <strong>data structures and algorithms</strong>. I tackled numerous
          problems on popular coding platforms such as <strong>LeetCode</strong>{' '}
